...
function renderAISynthesizedFallback(promptText) {
  ...
  if (subEl) subEl.innerText = `Grade Level: ${gradeSelect} • ${actSelect} • Complete all exercises carefully.`;
  ...
  const promptLower = promptText.toLowerCase().strip ? promptText.toLowerCase().strip() : promptText.toLowerCase();

  // Helper to extract key topic words from promptText
  const topicWords = promptText
  ...
  const mainKeyword = topicWords.length > 0 ? topicWords.join(' ') : cleanTitle;
  ...
  // Dynamic Content Generators per category
  let passageText = '';
  let wordBankList = [];
  let exercises = [];
  ...
  if (category === 'grammar') {
    ...
    exercises = [
      {
        num: 1,
        title: `1. Rule Application Drill (${cleanTitle})`,
        type: 'fill-in',
        question: `Fill in the blank with the appropriate form or concept related to ${cleanTitle}: "When revising a draft, a writer must check that each sentence correctly demonstrates proper ________."`,
        placeholder: `e.g., ${mainKeyword} / syntax / agreement`,
        answer: mainKeyword
      },
      {
        num: 2,
        title: '2. Multiple Choice Identification',
        type: 'mc',
        question: `Which of the following sentences correctly applies the principles of ${cleanTitle}?`,
        options: [
          `A) The student carefully reviewed the passage to apply standard ${mainKeyword} rules.`,
          `B) The student carefully review the passage with missing punctuation everywhere.`,
          `C) Carefully the student review without proper grammar or agreement structure.`,
          `D) Reviewing student passage without subject verb or proper syntax.`
        ],
        answer: 'A'
      },
      {
        num: 3,
        title: '3. Sentence Revision Drill',
        type: 'open',
        question: `Read the unedited sentence below:\n"the students was studying ${mainKeyword} in class yesterday when the teacher asked a question"\n\nTask: Rewrite the sentence above using correct capitalization, punctuation, and proper grammatical agreement.`,
      ...
      },
      {
        ...
        type: 'open',
        question: `Explain why using proper ${cleanTitle} improves the clarity of a written argument or story. Cite an example from your own writing.`,
      ...
      {
        num: 5,
        title: '5. Application & Composition',
        type: 'open',
        question: `Write two original sentences that demonstrate your complete understanding of ${cleanTitle}. Underline the target grammatical structure in each sentence.`,
    ...
    exercises = [
      {
        num: 1,
        title: `1. Device Classification (${cleanTitle})`,
        type: 'fill-in',
        question: `Identify the figurative language term: "A direct comparison between two unlike things using 'like' or 'as' is a simile, whereas stating one thing IS another is a ________."`,
      ...
      },
      {
        ...
        title: '2. Multiple Choice Identification',
        type: 'mc',
        question: `Read the quote: "The old library books were ancient treasures waiting to reveal their secrets." What figurative device is featured?`,
        options: [
      ...
      {
        num: 4,
        title: '4. Textual Analysis & Impact',
        type: 'open',
        question: `How does the author's use of ${cleanTitle} affect the emotional mood of a story or poem? Explain with details.`,
      ...
      {
        num: 5,
        title: '5. Creative Composition',
        type: 'open',
        question: `Create an original paragraph (3-4 sentences) describing a stormy night or a bustling city scene. Include at least two examples of ${cleanTitle}.`,
    ...
    exercises = [
      {
        num: 1,
        title: `1. Scientific Vocabulary (${cleanTitle})`,
        type: 'fill-in',
        question: `Complete the sentence with the correct scientific concept: "In the study of ${mainKeyword}, scientists formulate a tested ________ to explain observed phenomena."`,
        placeholder: 'hypothesis (e.g. hypothesis / opinion / guess)',
        answer: 'hypothesis'
      },
      {
        num: 2,
        title: '2. Multiple Choice Concept Check',
        type: 'mc',
        question: `Which statement accurately describes a core mechanism involved in ${cleanTitle}?`,
        options: [
      ...
      {
        num: 3,
        title: '3. Process Analysis & Diagram Explanation',
        type: 'open',
        question: `Describe the step-by-step process of ${cleanTitle}. What inputs are required, and what products or outcomes are generated?`,
      ...
      {
        num: 4,
        title: '4. Text-Based Evidence Question',
        type: 'open',
        question: `Based on the introductory passage, why is evidence-based observation critical when studying ${mainKeyword}?`,
      ...
      },
      {
        ...
        type: 'open',
        question: `How does our understanding of ${cleanTitle} impact everyday human life or environmental conservation?`,
    ...
    exercises = [
      {
        num: 1,
        title: `1. Historical Vocabulary (${cleanTitle})`,
        type: 'fill-in',
        question: `Fill in the blank: "An object created and used by humans during the historical period of ${mainKeyword} is known as a historical ________."`,
        placeholder: 'artifact (e.g. artifact / document / fossil)',
        answer: 'artifact'
      },
      {
        num: 2,
        title: '2. Multiple Choice Cause & Effect',
        type: 'mc',
        question: `What was a primary factor or historical catalyst surrounding ${cleanTitle}?`,
        options: [
      ...
      },
      {
        ...
        type: 'open',
        question: `Why do historians prioritize primary sources (such as letters, official decrees, or tools) when studying ${cleanTitle}?`,
      ...
      {
        num: 4,
        title: '4. Historical Impact & Geography',
        type: 'open',
        question: `How did geography or natural resources influence the development of ${cleanTitle}? Cite specific historical details.`,
      ...
      {
        num: 5,
        title: '5. Historical Synthesis & Reflection',
        type: 'open',
        question: `Summarize the lasting legacy of ${cleanTitle} on human society today in 2-3 well-constructed sentences.`,
    ...
    exercises = [
      {
        num: 1,
        title: `1. Mathematical Definitions (${cleanTitle})`,
        type: 'fill-in',
        question: `Complete the mathematical definition: "In fractions and ratios related to ${mainKeyword}, the top number that represents the parts selected is the ________."`,
        placeholder: 'numerator (e.g. numerator / denominator)',
        answer: 'numerator'
      },
      {
        num: 2,
        title: '2. Multiple Choice Computation',
        type: 'mc',
        question: `Which of the following expressions correctly represents a simplified or equivalent form of ${cleanTitle}?`,
        options: [
      ...
      {
        num: 3,
        title: '3. Scenario Word Problem Drill',
        type: 'open',
        question: `Word Problem: "A classroom is conducting an experiment involving ${cleanTitle}. If 3 out of 12 equal groups complete the assignment in the first hour, what simplified fraction and percentage of the total work is complete?"\n\nTask: Show your step-by-step work and state your final answer.`,
        placeholder: 'Show your work:\nSimplification:\nFinal Answer:',
        answer: '3/12 simplifies to 1/4, which is equivalent to 25% of the total work.'
      },
      {
        num: 4,
        title: '4. Mathematical Logic Explanation',
        type: 'open',
        question: `Explain why finding a common denominator or common factor is necessary when performing operations with ${mainKeyword}.`,
      ...
      {
        num: 5,
        title: '5. Student Problem Creation',
        type: 'open',
        question: `Create your own original math word problem involving ${cleanTitle}. Provide the solution and explanation below.`,
    ...
    exercises = [
      {
        num: 1,
        title: `1. Vocabulary & Concept Check (${cleanTitle})`,
        type: 'fill-in',
        question: `Define or complete the key concept related to ${cleanTitle}: "When studying this topic, readers must use ________ clues in the text to infer unfamiliar meanings."`,
        placeholder: 'context (e.g. context / random / literal)',
        answer: 'context'
      },
      {
        num: 2,
        title: '2. Multiple Choice Analytical Question',
        type: 'mc',
        question: `What is the primary objective when analyzing a text or lesson focusing on ${cleanTitle}?`,
        options: [
      ...
      {
        num: 3,
        title: '3. Text Structure & Evidence Drill',
        type: 'open',
        question: `Re-read the introductory passage on ${cleanTitle}. Identify the main idea of the paragraph and cite one specific detail that supports it.`,
      ...
      {
        num: 4,
        title: '4. Short Passage Comprehension',
        type: 'open',
        question: `Question: How does mastering ${cleanTitle} help students become more effective readers, writers, or thinkers? Support your answer with two reasons.`,
        placeholder: 'Reason 1:\nReason 2:',
        answer: `Mastering ${cleanTitle} improves reading comprehension, vocabulary acquisition, and evidence-based writing skills.`
      },
      {
        num: 5,
        title: '5. Creative Synthesis Response',
        type: 'open',
        question: `Write a short response (3-4 sentences) explaining what you learned about ${cleanTitle} today. Use at least two words from the Word Bank above.`,
  ...
  // Render Answer Key Section at the bottom if showAnswerKey is true OR as a distinct footer section
...
"""
    print("Fallback JavaScript code parsed successfully!")
